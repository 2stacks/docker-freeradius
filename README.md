...
File: configs/mysql/master/conf.d/max_allowed_packer.cnf
```
...
```
Note: The mysql docker image, associated schema, volumes and configs are not a port of the docker-freeradius image that can be pulled from docker hub.  See .dockerignore file for the parts of this repository that are excluded from the image.
